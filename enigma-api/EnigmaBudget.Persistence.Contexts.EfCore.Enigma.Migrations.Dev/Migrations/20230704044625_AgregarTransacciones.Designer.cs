...
namespace EnigmaBudget.Persistence.Contexts.EfCore.Enigma.Migrations.Dev.Migrations
{
    ...
    [Migration("20230704044625_AgregarTransacciones")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EnigmaBudget.Persistence.Contexts.EfCore.Enigma.Entities.DepositAccountEntity", b =>
                {
                    ...
                    b.HasIndex(new[] { "DeaTdaId" }, "FK_dea_tda");

                    b.HasIndex(new[] { "DeaUsuId" }, "FK_dea_usu");
            ...
            modelBuilder.Entity("EnigmaBudget.Persistence.Contexts.EfCore.Enigma.Entities.DepositAccountTransactionEntity", b =>
                {
                    ...
                    b.Property<decimal>("DatAmmount")
                        .HasPrecision(19, 4)
                        .HasColumnType("decimal(19,4)")
                        .HasColumnName("dat_ammount")
                        .HasComment("Monto del Movimiento");

                    b.Property<string>("DatCurrencyCode")
                        .IsRequired()
                        .HasMaxLength(3)
                        .HasColumnType("varchar(3)")
                    ...
                    b.HasIndex(new[] { "DatDeaId" }, "FK_dat_dea");

                    b.HasIndex(new[] { "DatUsuId" }, "FK_dat_usu");

                    b.HasIndex(new[] { "DatFechaBaja" }, "IDX_dat_baja");

                    b.ToTable("deposit_account_transactions", null, t =>
                        {
                            t.HasComment("Tabla con datos de transacciones de cuentas depósito");
                        });
                });
            ...
            modelBuilder.Entity("EnigmaBudget.Persistence.Contexts.EfCore.Enigma.Entities.DepositAccountTransactionEntity", b =>
                {
                    b.HasOne("EnigmaBudget.Persistence.Contexts.EfCore.Enigma.Entities.DepositAccountEntity", "DatDea")
                        .WithMany("DeaTrd")
            ...
            modelBuilder.Entity("EnigmaBudget.Persistence.Contexts.EfCore.Enigma.Entities.UsuarioEntity", b =>
                {
                    ...
                    b.Navigation("DepositAccountsTransactions");
